      ...
      <div id="posts-list" class="cf">
         ...
         <article>
            <div class="feature-image">
               ...
               <a href="/users/unfollow/<?=$post['post_user_id']?>_<?=$keyword?>" class="link-button red" style="
                  margin-top: 3px;width: 80px;">Unfollow</a>
               <!-- Otherwise, show the follow link -->
               <?php elseif($post['post_user_id'] != $user->user_id): ?>
               <a href="/users/follow/<?=$post['post_user_id']?>_<?=$keyword?>" class="link-button green" style="
